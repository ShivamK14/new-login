...
class _LoginPageState extends State<LoginPage> {
   ...
   RegisterRequestModel requestMode2;
  ...
  void initState(){
    ...
    requestMode2 = RegisterRequestModel();
  }
                  ...
                  Container(
                    ...
                    child: Row(
                      children: <Widget>[
                        ...
                        Expanded(
                          child: TextFormField(
                            onChanged: (input) => requestModel.username = input,
                   ...
                   Column(
                      children: <Widget>[
                        ...
                        Container(
                          ...
                          Expanded(
                          child: TextField(
                            onChanged: (input) => requestMode2.username=input,
                              decoration: InputDecoration(
                                hintText: 'Username',
                        ...
                        Container(
                          ...
                          child: Row(
                            children: <Widget>[
                              ...
                              Expanded(
                                child: TextField(
                                  onChanged: (input) => requestMode2.email=input,
                                  decoration: InputDecoration(
                        ...
                        Container(
                          ...
                          child: Row(
                            children: <Widget>[
                              ...
                              Expanded(
                                child: TextField(
                                  onChanged: (input) => requestMode2.mobile=input,
                                  obscureText: true,
                                  decoration: InputDecoration(
                        ...
                        Container(
                          ...
                          child: Row(
                            children: <Widget>[
                              ...
                              Expanded(
                                child: TextField(
                                  onChanged: (input) => requestMode2.password=input,
                                  obscureText: true,
                                  decoration: InputDecoration(
                                    hintText: 'Password',
                                    contentPadding: EdgeInsets.symmetric(vertical: 15),
                      ...
                      GestureDetector(
                        ...
                        onTap: () {
                          ...
                          setState(() {
                            isApicallprocess = true;
                            _pageState = 1;
                            print(requestMode2.username);
                            print(requestMode2.email);
                            print(requestMode2.mobile);
                            print(requestMode2.password);
                            APIService.register(requestMode2).then((value){
                              setState(() {
                                isApicallprocess = false;
                              });
